...
const AuthScreen: React.FC = () => {
  ...
  const { signInWithEmail, signUpWithEmail, resetPassword, signInWithGoogle, signInWithFacebook, user, loading: authLoading } = useAuth();
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 text-gray-500 dark:text-gray-400 bg-white dark:bg-black">
                    Or continue with
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <button 
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center space-x-3 py-3 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/20 rounded-xl text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:bg-white/10 transition-all duration-300 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button 
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center space-x-3 py-3 bg-blue-600 hover:bg-blue-700 border border-blue-600 dark:border-blue-500 rounded-xl text-white transition-all duration-300 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                >
